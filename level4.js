function level4(){
	...
	this.prompts=[
		...
		{reset: {backward:true, foward: false},  text:"Hopefully you found that with the large blocks, you couldn’t get all of the energy back out, making this an <i>irreversible</i> compression and expansion cycle.  From the graphs, I think there are two ways we can verify of this.  What might they be?"},
		{reset: {backward:false, forward:true},  text:"Each bin has the same total weight in it.  Try to compress the container with one bin’s worth of weight, but using less energy than you did to compress with the largest blocks."},
		...
		{reset: {backward:true, forward:false},  text:"If you take all of the weight back off, how does the total energy added in this cycle compare to the energy added in the cycle using the big blocks, and why is it different?"},
