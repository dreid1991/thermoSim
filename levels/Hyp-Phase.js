								...
								graphs: [
									{
										...
										sets: [
										{handle: 'fracVH', label: 'frac\nGas', pointCol:Col(50,255,50),flashCol:Col(200,255,200),data:{}, dataVals: {x:[0, 0.1, 0.4, 0.9], y:[400, 410, 402, 424]}, trace: true, fillInPts: true, fillInPtsMin: 5, recording: false},
