	...
	sections: [
		...
		// },
		{
			sceneData: {
				...
				dots: [
					//{spcName: 'spc1', pos: P(55, 155), dims: V(200, 20), count: 0, temp: 350, returnTo: 'wally', tag: 'wally'},
					{spcName: 'ugly', pos: P(55, 55), dims: V(200, 20), count: 1, temp: 298.15, returnTo: 'wally', tag: 'wally'}
