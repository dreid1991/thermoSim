...

		{
			sceneData: {
				...
				objs: [
					...
					{
						type: 'Cell',
						attrs: {pos: P(200, 200), rad: 70, col: Col(30, 200, 30), handle: 'squishy', parentWallHandle: 'wally'}
					},
					// {
				...
				cmmds: [
					...
					//'spcs.spc1.place([{pos: P(100, 50.1), dir: V(1, .01), temp: 30, tag: "wally", returnTo: "wally"}])'
