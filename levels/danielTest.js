			...
			sceneData: {
				...
				objs: [
					...
					},
					{
						...
						attrs: {handle: 'warpSpeed', temp: 300, tempMin: 200, tempMax: 400, wallInfo: 'wally', makeTempSlider: true, inletDepth: 20, outletDepth: 25, width: 30, pressure: 3, ptIdxs: [0, 1, 2, 3], flows: [{spcName: 'spc1', nDotMax: .05, tag: 'wally', handle: 'woop'}], sliders: [{flowHandles: ['woop'], title: 'hello', fracOpen: .5, handle: 'floppy'}]}
					}
					// {
						// type: 'Heater',
