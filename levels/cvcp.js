	...
	sections: [
		...
		{//B1
			...
			sceneData:
				{
					walls: [
						{pts:[P(40,190), P(255,190), P(255,425), P(40,425)], handler:'staticAdiabatic', handle:'left', bounds:undefined, vol:5, border: {type: 'wrap'}},
						{pts:[P(295,190), P(510,190), P(510,425), P(295,425)], handler:'staticAdiabatic', handle:'right', bounds:{yMin:50, yMax:275}, vol:5, border: {type: 'open', yMin: 50}}
					
					],

					dots: [
						{type: 'spc1', pos: P(45, 200), dims: V(200, 200), count: 350, temp: 185, returnTo: 'left', tag: 'left'},
						{type: 'spc3', pos: P(45, 200), dims: V(200, 200), count: 250, temp: 185, returnTo: 'left', tag: 'left'},
						
						{type: 'spc1', pos: P(300, 200), dims: V(200, 200), count: 350, temp: 185, returnTo: 'right', tag: 'right'},
						{type: 'spc3', pos: P(300, 200), dims: V(200, 200), count: 250, temp: 185, returnTo: 'right', tag: 'right'}
					],
					objs: [
						{type: 'Piston', attrs: {handle: 'RightPiston', wallInfo: 'right', min: 2, init: 2, max:7, makeSlider:false}},
						{type: 'Heater', attrs: {handle: 'heaterLeft', wallInfo: 'left'}},
						{type: 'Heater', attrs: {handle: 'heaterRight', wallInfo: 'right'}}
					],
					dataDisplay: [
