			...
			LevelTools, 
{
	declarePrompts: function(){
		this.prompts=[
			...
			{block:1,
				cutScene: true,
				text:"Indeed!  This means that is takes more energy to heat up the same gas at constant pressure than at constant volume.  Huh?  The gas is the same.  Why does it take different amounts of energy?</p><p>WE MUST FIND OUT!</p>",
			},
			{block:2,
				title:"Current step",
