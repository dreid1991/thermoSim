		...
		},
		{
			sceneData: {
				...
				triggers: [
					...
					{handle: 'refreshCheck', expr: 'wasReset', satisfyCmmds: ['sendToCW("Section was refreshed", 110)', 'console.log("shenanigans!")']}
				],	
			},
			prompts: [
				{
		...
		{	
			sceneData: {
				...
				triggers: [
					...
					{handle: 'refreshCheck', expr: 'wasReset', satisfyCmmds: ['sendToCW("Section was refreshed", 111)']}
				]	
			},
			prompts:[
				{
		...
		},
		{
			sceneData: {
				...
				triggers: [
					...
					{handle: 'refreshCheck', expr: 'wasReset', satisfyCmmds: ['sendToCW("Section was refreshed", 112)']}
				],	
			},
			prompts:[
				{
