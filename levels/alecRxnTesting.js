LevelData = {
	...
	spcDefs: [
		...
		{spcName: 'ugliest', m: 4, r: 2, sF298: -16.66667, col: Col(255, 30, 62), cv: 3 * R, hF298: -10, hVap298: 10, antoineCoeffs: {}, cpLiq: 12, spcVolLiq: 1}
	],
	mainSequence: [
		{//S0	
		sceneData: undefined, 	
		...
		{//S1
			sceneData: {
				...
				// ],
				rxnsNonEmergent: [
					{rcts: [{spcName: 'ugly', count: 1}], prods: [{spcName: 'ugliest', count: 2}], preExpForward: 5, activeEForward: 7, handle: 'reacty7'},
