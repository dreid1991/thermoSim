...
LevelData = {
	...
	spcDefs: [
		{spcName: 'spc1', m: 4, r: 1.5, col: Col(200, 0, 0), cv: 1.5 * R, hF298: -10, hVap298: 10, sF298: -1, antoineCoeffs: {a: 8.07, b: 1730.6, c: 233.4-273.15}, cpLiq: 2.5 * R, spcVolLiq: .3}, //act coeff will depend on mixture - don't put in spcDef
		{spcName: 'spc2', m: 4, r: 1.5, col: Col(150, 100, 255), cv: 1.5 * R, hF298: -10, hVap298: 10, sF298: -1, antoineCoeffs: {a: 8.213, b: 1652.27, c: 231.48-273.15}, cpLiq: 2.5 * R, spcVolLiq: .3},
...

		{
			sceneData: {
				...
				objs: [
					{
						type: 'Liquid',  
						attrs:{wallInfo: 'wally', handle: 'swishy', tempInit: 400, spcCounts: {spc1: 700}, makePhaseDiagram: true, triplePointTemp: 300, criticalPointTemp: 500/*,primaryKey: 'heavy', actCoeffType: 'vanlaar', actCoeffInfo: {spc1:.9227, spc2: 1.67}, makePhaseDiagram: true*/}
					},
					{
						type: 'Piston',
			...
			prompts: [
				{
					sceneData: undefined,
					title: '',
					text: 'This is the single component liquid/vapor equilibrium demo.  You can heat or cool the system using the heater or change the pressure using the weights.'
				}
			...
			prompts: [
				{
					sceneData: undefined,
					title: '',
					text: "Now we've added a non-condensable component to the vapor.  Notice that the partial pressure of the condensable species remains the same."
				}
